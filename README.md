...
结合 HTTP 流量捕获、RAG 语义检索、ReAct 推理循环和赏金激励机制的智能安全测试系统

[特性](#-核心特性) • [快速开始](#-快速开始) • [架构设计](#-架构设计) • [使用指南](#-使用指南) • [技术栈](#-技术栈)
...
1. **赏金激励机制** - 首创虚拟赏金系统，引导 AI 优化测试策略，提高漏洞发现准确率
2. **ReAct 推理循环** - 基于 Reasoning + Acting 模式的自主决策引擎
3. **RAG 语义检索** - 结合向量数据库实现智能流量分析和知识检索
4. **渐进式分析** - 多轮迭代分析，逐步深入挖掘潜在安全风险
